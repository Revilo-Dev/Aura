...
public final class AbilityKeybinds {
    ...
    private static void onClientTick(ClientTickEvent.Post event) {
        ...
        if (AuraClientConfig.disableSkillsAndAbilities()) return;
    ...
    private static void add(AbilityId id, String keyName, int defaultKey) {
        KeyMapping mapping = new KeyMapping("key.aura.ability." + keyName, defaultKey, CATEGORY);
        KEYS.put(id, mapping);
    ...
    private static void addElementShared(AbilityId id, String keyName, int defaultKey) {
        ...
        if (existing == null) {
            existing = new KeyMapping("key.aura.ability." + keyName, defaultKey, CATEGORY);
