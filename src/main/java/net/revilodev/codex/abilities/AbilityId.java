...
public enum AbilityId {
    ...
    ICE_PIERCE("Ice Pierce", "Piercing bullet of ice.", AbilityElement.ICE, AbilitySpecialization.PIERCE, AbilityNodeType.SPECIALIZATION, ICE_BURST, SkillId.RESISTANCE, 1, 180, "ice_pierce"),
    ICE_IMPLODE("Ice Implode", "Explosion that slows enemies.", AbilityElement.ICE, AbilitySpecialization.IMPLODE, AbilityNodeType.SPECIALIZATION, ICE_PIERCE, SkillId.RESISTANCE, 1, 240, "ice_nova"),
    ICE_GLACIER("Ice Glacier", "Ice spikes erupt from the ground.", AbilityElement.ICE, AbilitySpecialization.GLACIER, AbilityNodeType.SPECIALIZATION, ICE_IMPLODE, SkillId.RESISTANCE, 1, 360, "ice_storm"),
    ICE_STORM("Ice Storm", "Raining ice spikes.", AbilityElement.ICE, AbilitySpecialization.STORM, AbilityNodeType.SPECIALIZATION, ICE_GLACIER, SkillId.RESISTANCE, 1, 460, "ice_storm"),
    ...
    LIGHTNING_STRIKE("Lightning Strike", "Strike one enemy with lightning.", AbilityElement.LIGHTNING, AbilitySpecialization.STRIKE, AbilityNodeType.SPECIALIZATION, LIGHTNING, SkillId.AGILITY, 1, 120, "lightning_strike"),
    LIGHTNING_ZAP("Lightning Zap", "Strike multiple enemies with weak lightning.", AbilityElement.LIGHTNING, AbilitySpecialization.ZAP, AbilityNodeType.SPECIALIZATION, LIGHTNING_STRIKE, SkillId.AGILITY, 1, 180, "lightning_zap"),
    LIGHTNING_NOVA("Lightning Nova", "Radius that strikes nearby mobs.", AbilityElement.LIGHTNING, AbilitySpecialization.NOVA, AbilityNodeType.SPECIALIZATION, LIGHTNING_ZAP, SkillId.AGILITY, 1, 220, "lightning_nova"),
    LIGHTNING_IMPLODE("Lightning Implode", "Explosion that strikes enemies.", AbilityElement.LIGHTNING, AbilitySpecialization.IMPLODE, AbilityNodeType.SPECIALIZATION, LIGHTNING_NOVA, SkillId.AGILITY, 1, 260, "lightning_implode"),
    LIGHTNING_STORM("Lightning Storm", "Storm of many weak lightning bolts.", AbilityElement.LIGHTNING, AbilitySpecialization.STORM, AbilityNodeType.SPECIALIZATION, LIGHTNING_IMPLODE, SkillId.AGILITY, 1, 420, "lightning_nova"),

    POISON("Poison", "Mastery of poison abilities.", AbilityElement.POISON, null, AbilityNodeType.CORE, null, SkillId.LUCK, 5, 0, "poison"),
    POISON_BURST("Poison Burst", "Burst of poison projectiles.", AbilityElement.POISON, AbilitySpecialization.BURST, AbilityNodeType.SPECIALIZATION, POISON, SkillId.LUCK, 1, 120, "poison_burst"),
    POISON_NOVA("Poison Nova", "Radius circle of poison.", AbilityElement.POISON, AbilitySpecialization.NOVA, AbilityNodeType.SPECIALIZATION, POISON_BURST, SkillId.LUCK, 1, 200, "poison_nova"),
    POISON_IMPLODE("Poison Implode", "Explosion that poisons enemies.", AbilityElement.POISON, AbilitySpecialization.IMPLODE, AbilityNodeType.SPECIALIZATION, POISON_NOVA, SkillId.LUCK, 1, 260, "poison_implode"),

    FORCE("Force", "Mastery of force abilities.", AbilityElement.FORCE, null, AbilityNodeType.CORE, null, SkillId.RESISTANCE, 5, 0, "force"),
    FORCE_AEGIS("Force Aegis", "Protects player for hits, then knocks enemies back.", AbilityElement.FORCE, AbilitySpecialization.AEGIS, AbilityNodeType.SPECIALIZATION, FORCE, SkillId.RESISTANCE, 1, 260, "aegis"),
